...
export default angular
    ...
    .component('searchResultsItem', {
        ...
        controllerAs : 'searchResultsItem',
        template     : `
            <div class="container-fluid results-container">
                <div class="row justify-content-sm-center py-3">
                    <div class="col-10">
                        <p class="display-4 py-3">
                            {{ searchResultsItem.gem.name }} <span class="text-muted font-italic target-text">{{ searchResultsItem.gem.version }}<span>
                        </p>
                        <hr />
                    </div>
                </div>
                ...
                <div class="row justify-content-sm-center py-3">
                    <div class="col-7">
                        ...
                        <div class="row py-3">
                            <div class="col-6">
                                ...
                                <p><strong>{{ searchResultsItem.gem.version }}</strong> &dash;</p>
                            </div>
                            <div class="col-6">
                                <div ng-repeat="(key, dep) in searchResultsItem.gem.dependencies">
                        ...
                        <div class="row py-3">
                            <div class="col-12">
                                ...
                                <p>{{ searchResultsItem.gem.authors }}</p>
                    ...
                    <div class="col-3 bl-1 lp-6">
                        <div class="pb-3">
                            ...
                            <h4><strong>{{ searchResultsItem.gem.downloads | number }}</strong></h4>
                        </div>

                        <div class="pb-3">
                            <small class="text-uppercase"><strong>for this version</strong></small>
                            <h4><strong>{{ searchResultsItem.gem.version_downloads | number }}</strong></h4>
                        </div>
                    </div>
                </div>
            </div>
